...
},{}],"qlpU":[function(require,module,exports) {
'use strict';
...
},{"react":"n8MK","prop-types":"D9Od","gud":"bHnc","warning":"XOCG"}],"N8f8":[function(require,module,exports) {
'use strict';
...
module.exports = exports['default'];
},{"react":"n8MK","./implementation":"qlpU"}],"nkXc":[function(require,module,exports) {
"use strict";
...
exports.validateRedirect = exports.startsWith = exports.shallowCompare = exports.resolve = exports.pick = exports.match = exports.insertParams = void 0;
...
exports.navigate = exports.globalHistory = exports.createMemorySource = exports.createHistory = void 0;
...
exports.ServerLocation = exports.Router = exports.Redirect = exports.Match = exports.LocationProvider = exports.Location = exports.Link = void 0;
...
exports.useParams = exports.useNavigate = exports.useMatch = exports.useLocation = exports.redirectTo = void 0;
...
},{"react":"n8MK","prop-types":"D9Od","invariant":"gTpJ","create-react-context":"N8f8","react-lifecycles-compat":"nkXc","./lib/utils":"gj0I","./lib/history":"jT2L"}],"SpjQ":[function(require,module,exports) {
"use strict";
...
B.Push = "PUSH";
B.Replace = "REPLACE";
var C = "production" !== "production" ? function (b) {
  ...
  p.addEventListener("popstate", function () {
    if (u) f.call(u), u = null;else {
      ...
      if (f.length) {
        ...
        } else "production" !== "production" ? D(!1, "You are trying to block a POP navigation to a location that was not created by the history library. The block will fail silently in production, but in general you should do all navigation with the history library (instead of using window.history.pushState directly) to avoid this situation.") : void 0;
      } else z(c);
    }
  });
  var t = r.Pop;
...
function createHashHistory(b) {
  ...
  function y(a, e) {
    ...
    var g = r.Push,
        n = z(a, e);
    "production" !== "production" ? D("/" === n.pathname.charAt(0), "Relative pathnames are not supported in hash history.push(" + JSON.stringify(a) + ")") : void 0;
  ...
  function w(a, e) {
    ...
    var g = r.Replace,
        n = z(a, e);
    "production" !== "production" ? D("/" === n.pathname.charAt(0), "Relative pathnames are not supported in hash history.replace(" + JSON.stringify(a) + ")") : void 0;
    c.length && (c.call({
      action: g,
      location: n,
      retry: l
...
function createMemoryHistory(b) {
  ...
  function z(d, f) {
    var c = r.Push,
        a = h(d, f);
    "production" !== "production" ? D("/" === t.pathname.charAt(0), "Relative pathnames are not supported in memory history.push(" + JSON.stringify(d) + ")") : void 0;
    k(c, a, function () {
      z(d, f);
  ...
  function A(d, f) {
    var c = r.Replace,
        a = h(d, f);
    "production" !== "production" ? D("/" === t.pathname.charAt(0), "Relative pathnames are not supported in memory history.replace(" + JSON.stringify(d) + ")") : void 0;
    k(c, a, function () {
      A(d, f);
    }) && (p[m] = a, x(c, a));
  }
  ...
  var p = (void 0 === b ? ["/"] : b).map(function (d) {
    ...
    "production" !== "production" ? D("/" === f.pathname.charAt(0), "Relative pathnames are not supported in createMemoryHistory({ initialEntries }) (invalid entry: " + JSON.stringify(d) + ")") : void 0;
    return f;
  }),
...
function useOutlet() {
  return (0, _react.useContext)(RouteContext).outlet;
}
/**
...
const Link = /*#__PURE__*/(0, _react.forwardRef)(function LinkWithRef(_ref3, ref) {
  let {
    onClick,
    reloadDocument,
    replace = false,
...
const NavLink = /*#__PURE__*/(0, _react.forwardRef)(function NavLinkWithRef(_ref4, ref) {
  let {
...
},{"react":"n8MK","history":"UJ0C","react-router":"ojTu"}],"EDTP":[function(require,module,exports) {
'use strict';
...
},{"./impl":"R7zu","./animals":"KB0V"}],"EcQx":[function(require,module,exports) {
"use strict";
...
},{"@reach/router":"VJZj","react":"n8MK"}],"tKTj":[function(require,module,exports) {
"use strict";
...
const Results = _ref => {
  ...
  return /*#__PURE__*/_react.default.createElement("div", {
    className: "search"
  }, !pets.length ? /*#__PURE__*/_react.default.createElement("h1", null, "No Pets Found") : pets.map(pet => /*#__PURE__*/_react.default.createElement(_Pet.default, {
    animal: pet.type,
    key: pet.id,
    name: pet.name,
...
},{"react":"n8MK","./Pet":"EcQx"}],"pmSn":[function(require,module,exports) {
"use strict";
...
const SearchParams = () => {
  ...
  (0, _react.useEffect)(() => {
    ...
    _pet.default.breeds(animal).then(_ref => {
      let {
        breeds: apiBreeds
      } = _ref;
      // const breedStrings = breeds.map(obj => obj.name);
      const breedStrings = apiBreeds.map(_ref2 => {
        let {
          name
        } = _ref2;
        return name;
...
exports.default = _default;
},{"react":"n8MK","@frontendmasters/pet":"OpLS","./Results":"tKTj","./useDropdown":"pmSn","./ThemeContext":"DIxv"}],"a8IE":[function(require,module,exports) {
"use strict";
...
class Carousel extends _react.Component {
  ...
  static getDerivedStateFromProps(_ref) {
    ...
    if (media.length) photos = media.map(_ref2 => {
      let {
        large
      } = _ref2;
      return large;
...
exports.default = _default;
},{"react":"n8MK","@reach/router":"VJZj"}],"XGSj":[function(require,module,exports) {
"use strict";
...
class Details extends _react.default.Component {
  ...
  render() {
    ...
    return /*#__PURE__*/_react.default.createElement("div", {
      ...
      media: media
    }), /*#__PURE__*/_react.default.createElement("div", null, /*#__PURE__*/_react.default.createElement("h1", null, name), /*#__PURE__*/_react.default.createElement("h2", null, `${animal} — ${breed} — ${location}`), /*#__PURE__*/_react.default.createElement(_ThemeContext.default.Consumer, null, _ref2 => {
      let [theme] = _ref2;
    ...
    }), /*#__PURE__*/_react.default.createElement("p", null, description), showModal ? /*#__PURE__*/_react.default.createElement(_Modal.default, null, /*#__PURE__*/_react.default.createElement("h1", null, "Would you like to adopt ", name, "?"), /*#__PURE__*/_react.default.createElement("div", {
      className: "buttons"
...
//   );
// }
},{"react":"n8MK","@frontendmasters/pet":"OpLS","@reach/router":"VJZj","./Carousel":"a8IE","./Modal":"DtdL","./ErrorBoundary":"Vlsp","./ThemeContext":"DIxv"}],"lY9v":[function(require,module,exports) {
"use strict";
...
const App = () => {
  ...
  return /*#__PURE__*/_react.default.createElement(_react.StrictMode, null, /*#__PURE__*/_react.default.createElement(_ThemeContext.default.Provider, {
    value: themeHook
    ...
    to: "/"
  }, "Adopt Me!")), /*#__PURE__*/_react.default.createElement(_reactRouterDom.BrowserRouter, null, /*#__PURE__*/_react.default.createElement(_Details.default, {
    path: "/details/:id"
...
},{"react":"n8MK","react-dom":"NKHc","@reach/router":"VJZj","react-router-dom":"VGOX","./SearchParams":"oLoL","./Details":"XGSj","./ThemeContext":"DIxv"}]},{},["lY9v"], null)
//# sourceMappingURL=App.9c78f5a5.js.map